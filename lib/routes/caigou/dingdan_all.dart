...
import 'dingdan_mingxi.dart';

class dinghuoallPage extends StatefulWidget {
  const dinghuoallPage({Key? key}) : super(key: key);

  @override
  _dinghuollPageState createState() => _dinghuollPageState();
}

class _dinghuollPageState extends State<dinghuoallPage> {
  ...
  Future<void> _fetchData() async {
    ...
    final response = await http.get(Uri.parse(
        'http://pd.chi-na.cn/app/caigou/dinghuo_api.php?username=$username'));
